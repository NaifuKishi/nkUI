...
local mapElements = {
    ...
    --["RIFT.CRAFTING"]                  = { path = "gfx/riftCrafting.png",                   text = "Rift Crafting" },
    ["RIFT.MINOR.ACTIVE.FIRE"]         = { path = "gfx/mapIcons/iconRiftFire.png",          text = "Rift Minor" },    
    --["RIFT.MINOR.UNSTABLE.NIGHTMARE"]  = { path = "gfx/riftNightmare.png",                  text = "Unstable Minor\nNightmare Rift" },
    --["RIFT.MINOR.ACTIVE.NIGHTMARE"]    = { path = "gfx/riftNightmare.png",                  text = "Active Minor\nNightmare Rift" },
    ["RIFT.MAJOR.ACTIVE.FIRE"]         = { path = "gfx/mapIcons/iconRiftMajorFire.png",     text = "Rift Major" },
    --["RIFT.MAJOR.ACTIVE.NIGHTMARE"]    = { path = "gfx/riftNightmare.png",                  text = "Active Major\nNightmare Rift" },
    --["RIFT.MAJOR.UNSTABLE.NIGHTMARE"]  = { path = "gfx/riftNightmare.png",                  text = "Unstable Major\nNightmare Rift" },
    ["RIFT.EXPERT.ACTIVE.FIRE"]        = { path = "gfx/mapIcons/iconRiftExpertFire.png",        text = "Rift Expert" },
    --["RIFT.EXPERT.ACTIVE.NIGHTMARE"]   = { path = "gfx/mapIcons/riftNightmare.png",         text = "Active Expert\nNightmare Rift" },
    --["RIFT.EXPERT.UNSTABLE.NIGHTMARE"] = { path = "gfx/mapIcons/riftNightmare.png",         text = "Unstable Expert\nNightmare Rift" },
    ["RIFT.RAID.ACTIVE.FIRE"]          = { path = "gfx/mapIcons/iconRiftRaidFire.png",          text = "Rift Raid " },
    --["RIFT.RAID.ACTIVE.NIGHTMARE"]     = { path = "gfx/mapIcons/riftNightmare.png",         text = "Active Raid\nNightmare Rift" },
    --["RIFT.RAID.UNSTABLE.NIGHTMARE"]   = { path = "gfx/mapIcons/riftNightmare.png",         text = "Unstable Raid\nNightmare Rift" },
