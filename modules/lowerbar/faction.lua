...
function internalFunc.faction()
    ...
    local datasetFactionBar = EnKai.uiCreateFrame('nkFrame', "lowerBar.factionFrame", datasetFactionBarBG)
    ...
    local datasetFaction = EnKai.uiCreateFrame('nkText', "lowerBar.faction", datasetFactionBarBG)
    ...
    local datasetFactionName = EnKai.uiCreateFrame('nkText', "lowerBar.factionName", datasetFactionBar)
