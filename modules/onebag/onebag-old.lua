...
local function _oneBag.getRealCategory (category, rarity)
...
function oneBag.populateBag(forceCacheUpdate)
    ...
    for k, v in pairs(cachedItems) do
        local realCategory = _oneBag.getRealCategory(v.category, v.rarity)
...
local function oneBag.itemUpdate (_, a, b)
    --print "Hossa"
end
