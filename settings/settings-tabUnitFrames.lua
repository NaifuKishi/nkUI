...
function settingsUI.uiConfigTabUnitFrames (name, parent)
    ...
    function tabPane:build()
        ...
        paneTabUFTargetOfTarget = settingsUI.uiConfigTabUF(name .. ".tab.UnitFrames.TargetOfTarget", tabPane, "target.target", nkUISetup.modules.unitFrames.frames.targetOfTarget)
